...
# Insert the parent directory into sys.path to allow importing modules from the app directory
...
# Programmatically set the database URL in the Alembic config from settings (.env file)
